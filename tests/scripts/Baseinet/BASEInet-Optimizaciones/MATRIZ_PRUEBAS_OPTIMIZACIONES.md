...
## 📊 Resumen de Scripts - Optimizaciones (11 Scripts)
...
| **General<br/>(Multi-Flujo)** | `G2_PAQUETE_1_BASEINET_DRP_`<br/>`METODOS_GENERAL.jmx` | Suite completa:<br/>Login, Autorizaciones,<br/>Dispersiones y<br/>Consultas (Scripts<br/>01–09) | `ScValidateCuenta`,<br/>`ScDoIniciarSesion`,<br/>`CdDoAutorizarTraspaso`,<br/>`CdLoadArchivoLoteBase64`,<br/>`CdGetMovimientos`,<br/>entre otros | `usuarios_backend_`<br/>`baseinet_1800.csv` +<br/>`baseinet_Dispersion.csv` | | |
...
---
*Nota: Esta matriz contempla 11 scripts del módulo de Optimizaciones. Los scripts del Paquete 1 son los validados para producción; el script del Paquete 2 (`CdAddDestinatario`) es de uso auxiliar. El script `METODOS_GENERAL` agrupa múltiples flujos DRP en un único plan de prueba.*
