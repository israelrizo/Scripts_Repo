...
| **Cuentas<br/>Digitales** | `G2_PAQUETE_2_SCRIPT05_BASEINET_QA_CLOUD`<br/>`_OPTIMIZACIONES_MCD_CdAddDestinatario`<br/>`_DESTINATARIOS_ALTA_MASIVA.jmx` | Alta Masiva<br/>Destinatarios | `CdAddDestinatario` | `usuarios_backend_`<br/>`baseinet_agosto25.csv` | | |
...
---
*Nota: Esta matriz contempla únicamente los 10 scripts del módulo de Optimizaciones.*
